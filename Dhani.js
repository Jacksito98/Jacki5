...
case 'tovideo':
if (!isGroup) return reply(mess.only.group)
if (!isQuotedSticker) return reply('etiqueta stiker')
reply(mess.wait)
...
simple.sendMessage(from, buffer, video, { quoted: mek, caption: 'JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的' })
fs.unlinkSync(ran)
})
break
...
Dhani.sendMessage(from, buffer, image, {quoted: mek, caption: 'JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的'})
break
